...
export default class ProfessionalCertificates extends Component {
  constructor(props) {
    super(props);
    this.state = {
          ...
          <View
            ...
            <View
              ...
              <View
                ...
                <Text style={styles.userText}>Fellowship of Psychology</Text>
                <Text style={styles.designationText}> 2018,John Hopkins</Text>
              </View>
              {isEditOptionShow ? (
                <TouchableOpacity
                  onPress={() => {
            ...
            <View
              ...
              <View
                ...
                <Text style={styles.userText}>Mastering bipolar psychosis</Text>
                <Text style={styles.designationText}> 2020,EdX</Text>
              </View>
              {isEditOptionShow ? (
                <TouchableOpacity
                  style={{
