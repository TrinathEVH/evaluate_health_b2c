...
export default class ProfessionalMembership extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      <View>
        ...
        <View style={{flexDirection: 'row'}}>
          <View style={{width: '25%', alignItems: 'center', paddingTop: 4}}>
            <Image
              style={styles.qualificationIconImageStyle}
              source={require('../../../assets/icons/protectionShield.png')}
            />
          </View>
          ...
          <View
            ...
            <View
              ...
              <View
                ...
                <Text style={styles.designationText}>President, Finance</Text>
                <Text style={styles.designationText}>2018 - Present</Text>
              </View>
              {isEditOptionShow ? (
                <TouchableOpacity
                  onPress={() => {
              ...
              <View style={styles.neoContainerStyle}>
                <NeomorphBlur
                  ...
                  <View style={styles.betweenInputFieldStyle}>
                    <OutlinedTextField
                      label="Society Name"
                      title={'Ex Society of Thoracic Surgeons'}
                      type="text"
                      baseColor={Color.textColor}
                      tintColor={Color.blue}
                      fontSize={16}
