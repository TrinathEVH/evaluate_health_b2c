      ...
      <View>
        ...
        <View style={{flexDirection: 'row'}}>
          <View style={{width: '25%', alignItems: 'center', paddingTop: 4}}>
            <IconMaterialCommunityIcons name="office-building" size={31} />
          </View>
          ...
          <View
            ...
            <View
              ...
              <View
                ...
                <Text style={styles.userText}>Chief Consultant</Text>
                <Text style={styles.designationText}>AIIMS, Delhi</Text>
                <Text style={styles.designationText}>Jan 1995 onwards</Text>
              </View>
              {isEditOptionShow ? (
                <TouchableOpacity
                  onPress={() => {
              ...
              <View style={styles.neoContainerStyle}>
                <NeomorphBlur
                  ...
                  <View
                    ...
                    {/* 1. Dropdown Modal or hint text: states, cities within nation or global with hint option as he types.
                          2. One Location icon.. in suffix side to be visibile by default...if clicked will open add location details in text box */}
                    <OutlinedTextField
                  ...
                  {/* // i prefer to have one model open where it will open date picker and they will scroll instantly */}
                  <View
                    style={{
                      ...styles.betweenInputFieldStyle,
                    ...
                    <View style={{width: '2%'}} />
                    {/* Its not just time format:.. It should also show "ongoing" or "present" ..   */}
                    <View style={{width: '49%'}}>
                      <OutlinedTextField
                        label="End Date"
                        //type="text"
                  ...
                  <View style={{flexDirection: 'row'}}>
                    <View style={{width: '50%'}} />
                    <Checkbox label={'If Role is active'} />
                  </View>
                  <View
                    style={{
                      ...styles.betweenInputFieldStyle,
                  ...
                  {/* Dropdown list or modal to show two options : "Image or video " or "document"
                      1. If Image or video is selected: show suffix icon=> "gallary" and "camera" icons to open camera and gallary
                      2. if Document is selected: show suffix icon=> "gallary" icon to open document folder
                      3. User can able to add url from drives or dropbox...for Image or video or cerficate or document  */}
                  <View
                    style={{
                      ...styles.betweenInputFieldStyle,
                      ...styles.rowCenterStyle,
